...
- **`Mutations`** and **`Mutations/Operators`** — the 34 mutation operators, the registry that indexes them by the syntax kinds they support, the generator that applies them, and the compiler that verifies each mutant.
